	                ...
	                <div class="col-lg-6 col-md-6">
	                    <div class="product__details__pic">
	                        <div class="product__details__pic__item">
	                            <img class="product__details__pic__item--large" :src="store.detail.vo.poster" style="width: 100%; height:390px">
	                        </div>
	                    </div>
	                </div>
	                <div class="col-lg-6 col-md-6">
	...
	<script>
		const detailApp=Vue.createApp({
			setup(){
				...
				const params=new URLSearchParams(location.search)// 주소창의 물음표에 있는 값 가져오기
