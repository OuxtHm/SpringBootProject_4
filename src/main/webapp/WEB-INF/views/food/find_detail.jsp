					...
					<table class="table">
						<tr>
							<td class="text-center">
								...
								<button class="btn-success" style="width: 100px; height: 98px; float:left" @click="store.foodReplyInsert(fno, msgRef)">댓글쓰기</button>
							</td>
						</tr>
					</table>
				</c:if>
		...
		const app=createApp({
			setup(){
				...
				const addScript=()=>{
					...
					script.src="//dapi.kakao.com/v2/maps/sdk.js?&autoload=false&appkey=7d1d66f384fdb4c354c90e65a97ae96e&libraries=services"
