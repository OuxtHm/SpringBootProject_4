				...
				<table class="table">
					<tr>
						...
						<td class="text-left" width=90%>
							<input type="text" size=20 placeholder="ID를 입력하세요" class="input-sm" ref="idRef" v-model="store.id">
						</td>
					</tr>
					<tr>
						<td class="text-center" width=10%>PW</td>
						<td class="text-left" width=90%>
							<input type="password" size=20 placeholder="비밀번호를 입력하세요" class="input-sm" ref="pwdRef" v-model="store.pwd">
						</td>
					</tr>
					<tr>
